        ...
        <div class="content-box">
            <div class="row">
                <div class="col-sm-12 col-xxxl-6">
                    <div class="element-wrapper"><h6 class="element-header">Order Details</h6>
                        <br>
                        <br>
                                ...
                                <table class="table table-lightborder">
                                    ...
                                    @foreach($orders as $order)
                                        <tr>
                                            ...
                                            <td class="nowrap">{{$order->order_name}}</td>
                                            <td>
                                                <div class="cell-image-list">
                                                    <div class="cell-img"
                                                         style="background-image: url({{asset('uploads/cafe/'.$order->order_image)}})"></div>
                                                </div>
                                            </td>
                                            <td class="text-right">Ksh: {{$order->sum('order_price')}}</td>
                                            <td class="text-center">
                                                <form action="{{route('order.store')}}" method="post">
                                                    @csrf
                                                    <input type="hidden" name="getUserId" value="{{$order->user_id}}">
